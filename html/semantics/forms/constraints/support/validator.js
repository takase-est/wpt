var validator = {
  ...
  iterate_over: function(ctl, data) {
    ...
    var ctl_disabled = ctl.cloneNode(true);
    ctl_disabled.disabled = true;
    var ctl_readonly = ctl.cloneNode(true);
    ctl_readonly.readonly = true;
    var ctl_both = ctl.cloneNode(true);
    ctl_both.disabled = true;
    ctl_both.readonly = true;
    return [
      {ctl: ctl, data: data, condStr: '.'},
      {ctl: ctl_disabled, data: data, condStr: ', when control is disabled.'},
      {ctl: ctl_readonly, data: data, condStr: ', when control is readonly.'},
      {
        ctl: ctl_both,
        data: data,
